...

{
  ...
  networking.hostName = "hotei"; # Define your hostname.
...
services.displayManager.gdm.wayland = true;   # Wayland session
services.desktopManager.gnome.enable = true;
  ...
  # Make the fractional scaling toggle appear in Settings ▸ Displays
